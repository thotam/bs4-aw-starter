...
class InstallCommandStep3 extends Command
{
	 ...
	 * @var string
	 */
	protected $signature = 'bs4-aw-starters:install-step-3';
	 ...
	 * @var string
	 */
	protected $description = 'Install the Bootstrap 4 - Appwork - Starter Kits Step 3 install';
