...
@section('styles')
	<!-- Page -->
	<link rel="stylesheet" href="{{ mix('/css/thotam/error.css') }}">
@endsection
			...
			<div class="row w-100">
				<div class="d-flex col-md justify-content-center align-items-center order-2 order-md-1 position-relative p-5">
					...
					<div class="text-md-left text-center">
						...
						<span thotam-blockui wire:loading.attr="disabled" thotam-livewire-method="logout"><button type="button" class="btn btn-danger mx-2">←&nbsp; Đăng xuất</button></span>
